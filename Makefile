...
run-demos:
	...
	python3 test_harness.py demos/demo_math.el demos/demo_buffer.el demos/demo_variables.el demos/demo_engine.el demos/demo_markers.el demos/demo_transpiler.el
