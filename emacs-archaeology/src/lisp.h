...
#endif
#define GCTYPEMASK ((1L<<GCTYPEBITS) - 1)

#ifndef MARKBIT
#define MARKBIT (1L << (VALBITS + GCTYPEBITS - 1))
#endif
...
#define XINT(a) (((long)(a) << (64-VALBITS)) >> (64-VALBITS))
#endif
...
#define XSET(var, type, ptr) \
   ((var) = ((long)(type) << VALBITS) + ((long) (ptr) & VALMASK))
#endif
